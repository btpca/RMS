...
{
    public class CostCenterScheduleDTO
    {
        //========Contract Schedule//========
        [DisplayName("SL No")]
        public int SLNO { get; set; }

        [DisplayName("Cost Center Schedule SL No")]
        ...
        [DisplayName("CC Share %")]
        public double CCSharePercentage { get; set; }
        ...
        [DisplayFormat(DataFormatString = "{0:N2}")]
        [DisplayName("Net Rent Amount")]
        public double AiNetRentAmount { get; set; }

        [DisplayFormat(DataFormatString = "{0:N2}")]
        [DisplayName("CC Rent Amount")]
        public double CCRentAmount { get; set; }
        ...
        public string CCCodeCheckList { get; set; }
        public string VendorCodeCheckList { get; set; }
        public List<int> LandlordSLNoCheckList { get; set; }
        public string SubPremiseTypeCheckList { get; set; }


        public bool CheckboxCCWise { get; set; }
